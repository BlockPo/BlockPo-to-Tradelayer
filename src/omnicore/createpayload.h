...
std::vector<unsigned char> CreatePayload_IssuancePegged(uint8_t ecosystem, uint16_t propertyType, uint32_t previousPropertyId, std::string name, std::string name_traded, uint32_t propertyId, uint64_t amount);
