...
// {
//     if ( request.request.params.size() != 4)
//         throw runtime_error(
...
//
//     // obtain parameters & info
//     std::string fromAddress = ParseAddress(request.request.params[0]);
//     int64_t tempAlertType = request.request.params[1].get_int64();
...
//     int64_t tempExpiryValue = request.request.params[2].get_int64();
...
//     std::string alertMessage = ParseText(request.request.params[3]);
//
//     // create a payload for the transaction
