...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "omni_createpayload_createcontract", 4},
    ...
    { "omni_createpayload_cancelalltradescontract", 1},
    { "omni_closeposition", 1},
    { "omni_closeposition", 2},
    { "omni_createcontract", 1},
    { "omni_createcontract", 2},
    { "omni_createcontract", 5},
    ...
    { "omni_sendissuance_pegged", 6 },
    { "omni_sendissuance_pegged", 7 },
    // { "omni_sendissuance_pegged", 8 },
