...
SRCDIR=/media/sf_Ubuntu/TradeLayer/C++Codes/dev-lihki-domake/src

DATADIR=/media/sf_Ubuntu/TradeLayer/C++Codes/chain-lihki
NUL=/dev/null
printf "\n//////////////////////////////////////////\n"
printf "Cleaning the regtest folder\n"

sudo rm -r /media/sf_Ubuntu/TradeLayer/C++Codes/chain-lihki/regtest
sudo rm graphInfo*
