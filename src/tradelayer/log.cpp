...
bool msc_debug_parser                           = 1;
bool msc_debug_verbose                          = 1;
bool msc_debug_verbose2                         = 1;
bool msc_debug_verbose3                         = 1;
bool msc_debug_vin                              = 1;
bool msc_debug_script                           = 1;
bool msc_debug_send                             = 1;
bool msc_debug_tokens                           = 1;
bool msc_debug_spec                             = 0;
bool msc_debug_exo                              = 1;
