...
class HTTPBasicsTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Checking the LTC balance every address")
        for addr in addresses:
        ...
        params = str([addresses[0], 4, "1000", "300", 10000, "0.00001", "2", 1]).replace("'",'"')
        # self.log.info(params)
